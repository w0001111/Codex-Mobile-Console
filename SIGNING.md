...
ssh-keygen -Y verify \
  ...
  -s codex-mobile-console-0.2.0-rc.8.zip.sig \
  < codex-mobile-console-0.2.0-rc.8.zip
```
...
```sh
python3 scripts/release_signature.py verify ../codex-mobile-console-0.2.0-rc.8.zip \
  --signature ../codex-mobile-console-0.2.0-rc.8.zip.sig \
